...
pub contract LinkCartToken: FungibleToken {
    ...
    pub resource Vault: FungibleToken.Provider, FungibleToken.Receiver, FungibleToken.Balance {
        ...
        pub fun deposit(from: @FungibleToken.Vault) {
            let vault <- from as! @LinkCartToken.Vault
        ...
        destroy() {
            if self.balance > 0.0 {
                LinkCartToken.totalSupply = LinkCartToken.totalSupply - self.balance
            }
        }
        }
    ...
    pub resource Minter {
        ...
        ///
        pub fun mintTokens(amount: UFix64): @LinkCartToken.Vault {
            pre {
                amount > 0.0: "Amount minted must be greater than zero"
                amount <= self.allowedAmount: "Amount minted must be less than the allowed amount"
            }
            LinkCartToken.totalSupply = LinkCartToken.totalSupply + amount
    ...
    init() {
        ...
        self.account.link<&LinkCartToken.Vault{FungibleToken.Balance}>(
