...
function deployBatchConversionPayment(args, hre) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        try {
            ...
            const conversionPathInstance = lib_2.chainlinkConversionPath.connect('private', owner);
            ...
            const batchConversion = lib_1.batchConversionPaymentsArtifact.connect(hre.network.name, owner);
