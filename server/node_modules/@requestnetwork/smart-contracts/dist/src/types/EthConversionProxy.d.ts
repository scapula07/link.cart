...
interface EthConversionProxyInterface extends ethers.utils.Interface {
  functions: {
    ...
    "transferWithReferenceAndFee(address,uint256,address[],bytes,uint256,address,uint256)": FunctionFragment;
    "updateConversionPathAddress(address)": FunctionFragment;
    "updateConversionProxyAddress(address)": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "updateConversionProxyAddress",
    values: [string]
  ): string;
  ...
  events: {
    "TransferWithConversionAndReference(uint256,address,bytes,uint256,uint256)": EventFragment;
    "TransferWithReferenceAndFee(address,uint256,bytes,uint256,address)": EventFragment;
    "WhitelistAdminAdded(address)": EventFragment;
    "WhitelistAdminRemoved(address)": EventFragment;
  };

  getEvent(
    nameOrSignatureOrTopic: "TransferWithConversionAndReference"
  ): EventFragment;
  getEvent(
...
export class EthConversionProxy extends BaseContract {
  ...
  interface: EthConversionProxyInterface;
  ...
  functions: {
    ...
    updateConversionPathAddress(
      _chainlinkConversionPathAddress: string,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;

    updateConversionProxyAddress(
