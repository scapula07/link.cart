 ...
 */
const setupETHConversionProxy = (contractAddress, hre) => (0, tslib_1.__awaiter)(void 0, void 0, void 0, function* () {
    // Setup contract parameters
    const EthConversionProxyContract = new hre.ethers.Contract(contractAddress, lib_1.batchPaymentsArtifact.getContractAbi());
    yield Promise.all(hre.config.xdeploy.networks.map((network) => (0, tslib_1.__awaiter)(void 0, void 0, void 0, function* () {
        ...
        const EthConversionProxyConnected = yield EthConversionProxyContract.connect(signer);
        const adminNonce = yield signer.getTransactionCount();
        const gasPrice = yield provider.getGasPrice();
        // start from the adminNonce, increase gasPrice if needed
        yield Promise.all([
            (0, adminTasks_1.updatePaymentErc20FeeProxy)(EthConversionProxyConnected, network, adminNonce, gasPrice),
            (0, adminTasks_1.updateChainlinkConversionPath)(EthConversionProxyConnected, network, adminNonce + 1, gasPrice),
        ]);
    })));
