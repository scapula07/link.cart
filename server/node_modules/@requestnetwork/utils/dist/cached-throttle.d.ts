 ...
 */
export declare const cachedThrottle: <TParams extends unknown[], TReturn>(target: (...params: TParams) => Promise<TReturn>, minimumDelay: number) => (...params: TParams) => Promise<TReturn>;
export default cachedThrottle;
//# sourceMappingURL=cached-throttle.d.ts.map