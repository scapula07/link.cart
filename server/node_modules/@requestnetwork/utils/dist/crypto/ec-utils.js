 ...
 * @returns the address
 */
function recover(signature, data) {
    try {
...
function encrypt(publicKey, data) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        try {
            ...
            const encrypted = yield EcCrypto.encrypt(Buffer.from(compressed), Buffer.from(data));
...
function decrypt(privateKey, encrypted) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        try {
            const buf = yield EcCrypto.decrypt(Buffer.from(privateKey.replace(/^0x/, ''), 'hex'), eciesSplit(encrypted));
            return buf.toString();
        }
        catch (e) {
