...
const getCeloProvider = () => {
    ...
    provider.formatter._block = (value, format) => {
        return originalBlockFormatter(Object.assign({ gasLimit: ethers_1.constants.Zero }, value), format);
    };
    return provider;
};
...
const isEip1559Supported = (provider, logger) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        logger &&
            logger.warn('This RPC provider does not support the "eth_feeHistory" method: switching to legacy gas price');
        return false;
    }
});
exports.isEip1559Supported = isEip1559Supported;
