...
const isValidNearAddress = (address, network) => {
    if (!network) {
        return ((0, exports.isValidNearAddress)(address, 'aurora') ||
            (0, exports.isValidNearAddress)(address, 'aurora-testnet') ||
            (0, exports.isValidNearAddress)(address, 'near-testnet'));
    }
