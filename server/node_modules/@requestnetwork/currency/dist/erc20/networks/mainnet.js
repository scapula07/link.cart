...
const metamaskContractMap = (0, tslib_1.__importStar)(require("@metamask/contract-metadata"));
...
exports.supportedMainnetERC20 = Object.assign(Object.assign({}, Object.entries(metamaskContractMap)
    .filter(([, val]) => val.erc20)
    .reduce((prev, [key, val]) => (Object.assign(Object.assign({}, prev), { [key]: {
        name: val.name,
        symbol: val.symbol,
