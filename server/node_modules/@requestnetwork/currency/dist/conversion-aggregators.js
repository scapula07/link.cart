...
const node_dijkstra_1 = (0, tslib_1.__importDefault)(require("node-dijkstra"));
const private_json_1 = (0, tslib_1.__importDefault)(require("./aggregators/private.json"));
const mainnet_json_1 = (0, tslib_1.__importDefault)(require("./aggregators/mainnet.json"));
const goerli_json_1 = (0, tslib_1.__importDefault)(require("./aggregators/goerli.json"));
const rinkeby_json_1 = (0, tslib_1.__importDefault)(require("./aggregators/rinkeby.json"));
const matic_json_1 = (0, tslib_1.__importDefault)(require("./aggregators/matic.json"));
const fantom_json_1 = (0, tslib_1.__importDefault)(require("./aggregators/fantom.json"));
const near_json_1 = (0, tslib_1.__importDefault)(require("./aggregators/near.json"));
const near_testnet_json_1 = (0, tslib_1.__importDefault)(require("./aggregators/near-testnet.json"));
const aurora_testnet_json_1 = (0, tslib_1.__importDefault)(require("./aggregators/aurora-testnet.json"));
