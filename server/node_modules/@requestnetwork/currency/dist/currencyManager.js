...
const multicoin_address_validator_1 = (0, tslib_1.__importDefault)(require("multicoin-address-validator"));
const erc20_1 = require("./erc20");
const erc777_1 = require("./erc777");
const getHash_1 = require("./getHash");
const iso4217_1 = (0, tslib_1.__importDefault)(require("./iso4217"));
...
class CurrencyManager {
     ...
     */
    static fromInput(_a) {
        var { id, hash, meta } = _a, input = (0, tslib_1.__rest)(_a, ["id", "hash", "meta"]);
        if ('address' in input) {
