...
export interface IExtension<T = any> {
    ...
    applyActionToExtension: (extensionsState: RequestLogic.IExtensionStates, extensionAction: IAction<T>, requestState: RequestLogic.IRequest, actionSigner: Identity.IIdentity, timestamp: number) => RequestLogic.IExtensionStates;
}
export declare type ApplyAction<T = any> = (extensionState: IState<T>, extensionAction: IAction<T>, requestState: RequestLogic.IRequest, actionSigner: Identity.IIdentity, timestamp: number) => IState<T>;
...
declare type EnumToType<T> = T[keyof T];
export declare type ID = EnumToType<typeof ID>;
/** Type of extensions */
...
export declare type SupportedActions = {
