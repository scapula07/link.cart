...
export declare type IReturnPersistTransactionRaw = {
    /** meta information */
    meta: {
...
export declare type IReturnPersistTransaction = EventEmitter & IReturnPersistTransactionRaw;
...
export interface IReturnGetTransactions {
    ...
    /** result of the execution */
    result: {
        transactions: ITimestampedTransaction[];
    };
}
...
export interface IReturnGetChannelsByTopic {
    ...
    result: {
        transactions: ITransactionsByChannelIds;
    };
}
...
export interface ITransactionIndex {
    ...
    getChannelIdsForMultipleTopics(topics: string[], timestampBoundaries?: ITimestampBoundaries): Promise<string[]>;
...
//# sourceMappingURL=data-access-types.d.ts.map