...
export declare type PaymentNetworkCreateParameters = {
    id: ExtensionTypes.PAYMENT_NETWORK_ID.ERC20_PROXY_CONTRACT | ExtensionTypes.PAYMENT_NETWORK_ID.ETH_INPUT_DATA | ExtensionTypes.PAYMENT_NETWORK_ID.NATIVE_TOKEN;
    parameters: ExtensionTypes.PnReferenceBased.ICreationParameters;
} | {
    id: ExtensionTypes.PAYMENT_NETWORK_ID.ERC20_FEE_PROXY_CONTRACT | ExtensionTypes.PAYMENT_NETWORK_ID.ETH_FEE_PROXY_CONTRACT;
    ...
    id: ExtensionTypes.PAYMENT_NETWORK_ID.BITCOIN_ADDRESS_BASED | ExtensionTypes.PAYMENT_NETWORK_ID.TESTNET_BITCOIN_ADDRESS_BASED | ExtensionTypes.PAYMENT_NETWORK_ID.ERC20_ADDRESS_BASED;
...
export declare enum EVENTS_NAMES {
    PAYMENT = "payment",
    REFUND = "refund",
    ESCROW = "escrow"
}
export declare enum ESCROW_EVENTS_NAMES {
...
/** Balance error codes */
export declare enum BALANCE_ERROR_CODE {
    UNKNOWN = 0,
    WRONG_EXTENSION = 1,
    NETWORK_NOT_SUPPORTED = 2,
...
export interface IPaymentNetworkEvent<TEventParameters, TEventNames = EVENTS_NAMES> extends IPaymentNetworkBaseEvent<TEventNames> {
    amount: string;
...
export declare type DeclarativePaymentNetworkEvent = IPaymentNetworkEvent<IDeclarativePaymentEventParameters>;
/** Declarative BalanceWithEvents */
export declare type DeclarativeBalanceWithEvents = IBalanceWithEvents<IDeclarativePaymentEventParameters>;
/** Generic info retriever interface without transfers */
export interface IPaymentNetworkBaseInfoRetriever<TPaymentNetworkEvent extends IPaymentNetworkBaseEvent<TEventNames>, TEventNames = EVENTS_NAMES> {
    getAllContractEvents(): Promise<TPaymentNetworkEvent[]>;
}
/**
 * ERC777 networks and events
 */
export declare enum STREAM_EVENT_NAMES {
...
export declare type ERC777PaymentNetworkEvent = IPaymentNetworkEvent<IERC777PaymentEventParameters>;
/** ERC777 BalanceWithEvents */
export declare type ERC777BalanceWithEvents = IBalanceWithEvents<IERC777PaymentEventParameters>;
/**
...
export declare type ERC20PaymentNetworkEventParameters = IERC20PaymentEventParameters | IERC20FeePaymentEventParameters;
/** ERC20 Payment Network Event */
export declare type ERC20PaymentNetworkEvent = IPaymentNetworkEvent<ERC20PaymentNetworkEventParameters>;
/** ERC20 BalanceWithEvents */
export declare type ERC20BalanceWithEvents = IBalanceWithEvents<IERC20PaymentEventParameters>;
/**
 * Conversion-related events
 */
export declare type ConversionPaymentNetworkEventParameters = IERC20PaymentEventParameters | IERC20FeePaymentEventParameters | IETHPaymentEventParameters | IETHFeePaymentEventParameters;
export declare type ConversionPaymentNetworkEvent = IPaymentNetworkEvent<ConversionPaymentNetworkEventParameters>;
/**
...
export declare type ETHPaymentNetworkEventParameters = IETHPaymentEventParameters | IETHFeePaymentEventParameters;
/** ETH Payment Network Event */
export declare type ETHPaymentNetworkEvent = IPaymentNetworkEvent<ETHPaymentNetworkEventParameters>;
/** ETH BalanceWithEvents */
export declare type ETHBalanceWithEvents = IBalanceWithEvents<ETHPaymentNetworkEventParameters>;
/**
...
export interface IBitcoinDetectionProvider {
    getAddressBalanceWithEvents: (bitcoinNetworkId: number, address: string, eventName: EVENTS_NAMES) => Promise<IBalanceWithEvents<IBTCPaymentEventParameters>>;
}
...
export declare type BTCPaymentNetworkEvent = IPaymentNetworkEvent<IBTCPaymentEventParameters>;
/** BTC BalanceWithEvents */
export declare type BTCBalanceWithEvents = IBalanceWithEvents<IBTCPaymentEventParameters>;
...
export declare type EscrowEvents = IEscrowEventParameters;
export declare enum ESCROW_STATE {
    PAID_ESCROW = "paidEscrow",
    IN_FROZEN = "frozen",
...
export declare type EscrowData = IEscrowParameters;
...
export declare type EscrowChainData = IEscrowChainData;
/** escrow payment network event */
export interface IPaymentNetworkEscrowEvent<TEventParameters, TEventNames = EVENTS_NAMES> extends IPaymentNetworkBaseEvent<TEventNames> {
    parameters?: TEventParameters;
}
export declare type EscrowNetworkEvent = IPaymentNetworkEscrowEvent<IEscrowEventParameters, EVENTS_NAMES>;
export declare type AllNetworkEvents<TMyEventParameters> = {
    paymentEvents: IPaymentNetworkEvent<TMyEventParameters>[];
    escrowEvents?: EscrowNetworkEvent[];
};
export declare type AllNetworkRetrieverEvents<TPaymentNetworkEventType> = {
...
export declare enum BATCH_PAYMENT_NETWORK_ID {
    BATCH_MULTI_ERC20_CONVERSION_PAYMENTS = 0,
    BATCH_ERC20_PAYMENTS = 1,
    BATCH_MULTI_ERC20_PAYMENTS = 2,
    BATCH_ETH_PAYMENTS = 3,
    BATCH_ETH_CONVERSION_PAYMENTS = 4
}
