...
export interface IAnyDeclarative<TCreationParameters = ICreationParameters> extends Extension.IExtension<TCreationParameters> {
    ...
    createAddPaymentInstructionAction: (parameters: IAddPaymentInstructionParameters) => Extension.IAction;
    createAddRefundInstructionAction: (parameters: IAddRefundInstructionParameters) => Extension.IAction;
...
//# sourceMappingURL=pn-any-declarative-types.d.ts.map