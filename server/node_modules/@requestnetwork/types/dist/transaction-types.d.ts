...
export interface ITransactionManager {
    persistTransaction: (transactionData: ITransactionData, channelId: string, topics?: string[], encryptionParams?: Encryption.IEncryptionParameters[]) => Promise<IReturnPersistTransaction>;
    getTransactionsByChannelId: (channelId: string, timestampBoundaries?: ITimestampBoundaries) => Promise<IReturnGetTransactions>;
    getChannelsByTopic: (topic: string, updatedBetween?: ITimestampBoundaries) => Promise<IReturnGetTransactionsByChannels>;
    getChannelsByMultipleTopics: (topics: string[], updatedBetween?: ITimestampBoundaries) => Promise<IReturnGetTransactionsByChannels>;
}
...
export interface IReturnGetTransactions {
    ...
    /** result of the execution */
    result: {
        transactions: Array<ITimestampedTransaction | null>;
    };
}
/** return interface for getTransactionsByChannelId  */
export interface IReturnGetTransactionsByChannels {
    ...
    meta: {
        ...
        /** Ignored transactions */
        ignoredTransactions: {
            [key: string]: Array<IIgnoredTransaction | null>;
        };
    };
    /** result of the execution */
    result: {
        transactions: {
            [key: string]: Array<ITimestampedTransaction | null>;
        };
    };
}
...
/** Transaction data */
export declare type ITransactionData = string;
/** Ignored transaction */
