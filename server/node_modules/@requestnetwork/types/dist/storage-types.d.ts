...
export declare type IIpfsConfig = {
...
export declare type IAppendResult = EventEmitter & IEntry;
...
/** Enum of state possible for data */
export declare enum ErrorEntries {
    IPFS_CONNECTION_ERROR = 0,
    INCORRECT_FILE = 1,
    WRONG_FEES = 2
}
...
export declare enum IpfsGatewayProtocol {
    HTTP = "http",
    HTTPS = "https"
}
/** Storage type for now only ethereum + ipfs available */
export declare enum StorageSystemType {
    /** Ethereum and IPFS */
...
/** Gas price type */
export declare enum GasPriceType {
    FAST = "fast",
    STANDARD = "standard",
    SAFELOW = "safeLow"
}
