...
export interface IAdvancedLogic {
    ...
    getNativeTokenExtensionForNetwork: (network: string) => Extension.IExtension<Extension.PnReferenceBased.ICreationParameters> | undefined;
    getAnyToNativeTokenExtensionForNetwork: (network: string) => Extension.IExtension<Extension.PnAnyToEth.ICreationParameters> | undefined;
