...
export declare type MultiFormatSerialized = string;
/** Length of a formatted normalized Keccak256 hash (prefix + hash = 2 + 64 = 66) (no 0x expected) */
export declare const FORMAT_NORMALIZE_KECCAK256_HASH_LENGTH = 66;
/** Length of a formatted ethereum address identity (prefix + address = 2 + 40 = 42) (no 0x expected) */
export declare const FORMAT_IDENTITY_ETHEREUM_ADDRESS_LENGTH = 42;
//# sourceMappingURL=multi-format-types.d.ts.map