...
export interface IPaymentNetwork<TEventParameters extends GenericEventParameters = GenericEventParameters> {
...
export type PaymentNetworkCreateParameters = {
    ...
    id: ExtensionTypes.PAYMENT_NETWORK_ID.ERC20_FEE_PROXY_CONTRACT | ExtensionTypes.PAYMENT_NETWORK_ID.ETH_FEE_PROXY_CONTRACT | ExtensionTypes.PAYMENT_NETWORK_ID.ERC20_TRANSFERABLE_RECEIVABLE;
...
export type ERC20PaymentNetworkEventParameters = IERC20PaymentEventParameters | IERC20FeePaymentEventParameters;
 ...
 */
export type ConversionPaymentNetworkEventParameters = IERC20PaymentEventParameters | IERC20FeePaymentEventParameters | IETHPaymentEventParameters | IETHFeePaymentEventParameters;
...
export type ETHPaymentNetworkEventParameters = IETHPaymentEventParameters | IETHFeePaymentEventParameters;
...
export interface IBitcoinDetectionProvider {
    getAddressBalanceWithEvents: (bitcoinNetworkId: number, address: string, eventName: EVENTS_NAMES) => Promise<IBalanceWithEvents<GenericEventParameters>>;
}
