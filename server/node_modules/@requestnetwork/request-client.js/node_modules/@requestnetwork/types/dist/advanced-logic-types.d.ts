...
export interface IAdvancedLogic {
    applyActionToExtensions: (extensionsState: RequestLogic.IExtensionStates, extensionAction: Extension.IAction, requestState: RequestLogic.IRequest, actionSigner: Identity.IIdentity, timestamp: number) => RequestLogic.IExtensionStates;
    getNativeTokenExtensionForNetwork: (network: ChainName) => Extension.IExtension<Extension.PnReferenceBased.ICreationParameters> | undefined;
    getAnyToNativeTokenExtensionForNetwork: (network: ChainName) => Extension.IExtension<Extension.PnAnyToEth.ICreationParameters> | undefined;
    getFeeProxyContractErc20ForNetwork: (network?: ChainName) => Extension.PnFeeReferenceBased.IFeeReferenceBased | undefined;
...
//# sourceMappingURL=advanced-logic-types.d.ts.map