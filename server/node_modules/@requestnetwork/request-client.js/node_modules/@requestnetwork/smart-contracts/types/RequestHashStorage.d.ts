...
interface RequestHashStorageInterface extends ethers.utils.Interface {
  functions: {
    "addWhitelistAdmin(address)": FunctionFragment;
    "addWhitelisted(address)": FunctionFragment;
    "declareNewHash(string,bytes)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "declareNewHash",
  ...
  events: {
    "NewHash(string,address,bytes)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "NewHash"): EventFragment;
...
export class RequestHashStorage extends BaseContract {
  ...
  interface: RequestHashStorageInterface;
  ...
  filters: {
    NewHash(
      ...
      { hash: string; hashSubmitter: string; feesParameters: string }
    >;
