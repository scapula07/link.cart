...
interface ERC20TransferableReceivableInterface extends ethers.utils.Interface {
  functions: {
    ...
    "mint(address,bytes,uint256,address,string)": FunctionFragment;
  ...
  encodeFunctionData(
    ...
    values: [BigNumberish, BigNumberish, BytesLike, BigNumberish, string]
  ): string;
  encodeFunctionData(
  ...
  events: {
    ...
    "TransferableReceivablePayment(address,address,uint256,address,uint256,address,uint256,bytes)": EventFragment;
  };
  ...
  getEvent(
    nameOrSignatureOrTopic: "TransferableReceivablePayment"
  ): EventFragment;
}

export class ERC20TransferableReceivable extends BaseContract {
  ...
  filters: {
    ...
    TransferableReceivablePayment(
      ...
      [string, string, BigNumber, string, BigNumber, string, BigNumber, string],
      {
        sender: string;
        recipient: string;
        amount: BigNumber;
