...
interface IERC20FeeProxyInterface extends ethers.utils.Interface {
  functions: {
    "transferFromWithReferenceAndFee(address,address,uint256,bytes,uint256,address)": FunctionFragment;
  };
...
export class IERC20FeeProxy extends BaseContract {
