...
export { IAddPaymentAddressParameters, IAddRefundAddressParameters, } from './pn-any-reference-based-types';
/** Fee reference-based payment network extension interface */
export interface IFeeReferenceBased<TCreationParameters = ICreationParameters> extends PnReferenceBased.IReferenceBased<TCreationParameters> {
...
//# sourceMappingURL=pn-any-fee-reference-based-types.d.ts.map