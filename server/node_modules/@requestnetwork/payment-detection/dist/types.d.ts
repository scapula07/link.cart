...
export interface IGraphEventsRetriever<TPaymentNetworkEvent extends PaymentTypes.IPaymentNetworkEvent<unknown, TEventNames>, TEventNames = PaymentTypes.EVENTS_NAMES> {
...
export declare type IPaymentNetworkModuleByType = Partial<Record<ExtensionTypes.PAYMENT_NETWORK_ID, new (...pnParams: any) => PaymentDetectorBase<ExtensionTypes.IExtension, any>>>;
...
export declare type PaymentNetworkOptions = {
...
export declare type ReferenceBasedDetectorOptions = {
    advancedLogic: AdvancedLogicTypes.IAdvancedLogic;
    currencyManager: ICurrencyManager;
};
export declare type NativeDetectorOptions = ReferenceBasedDetectorOptions & {
    network: string;
};
