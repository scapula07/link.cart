 ...
 */
export default class ProxyERC20InfoRetriever implements IPaymentRetriever<PaymentTypes.ERC20PaymentNetworkEvent> {
     ...
     */
    constructor(paymentReference: string, proxyContractAddress: string, proxyCreationBlockNumber: number, tokenContractAddress: string, toAddress: string, eventName: PaymentTypes.EVENTS_NAMES, network: string);
    /**
     * Retrieves transfer events for the current contract, address and network.
     */
    getTransferEvents(): Promise<PaymentTypes.ERC20PaymentNetworkEvent[]>;
}
