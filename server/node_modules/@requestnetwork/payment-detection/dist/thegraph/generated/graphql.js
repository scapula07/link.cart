...
exports.GetSyncedBlock = exports.GetPaymentsAndEscrowState = exports.GetLastSyncedBlock = exports.EscrowEventResult = exports.PaymentEventResult = exports.getSdk = exports.GetSyncedBlockDocument = exports.GetPaymentsAndEscrowStateDocument = exports.GetLastSyncedBlockDocument = exports.EscrowEventResultFragmentDoc = exports.PaymentEventResultFragmentDoc = exports._SubgraphErrorPolicy_ = exports.Payment_OrderBy = exports.OrderDirection = exports.EventName = exports.Escrow_OrderBy = exports.EscrowState = exports.EscrowEvent_OrderBy = void 0;
...
exports.GetPaymentsAndEscrowStateDocument = (0, graphql_tag_1.default) `
  ...
  payments(
    where: {reference: $reference, to: $to}
    orderBy: timestamp
    orderDirection: asc
  ) {
    ...PaymentEventResult
...
function getSdk(client, withWrapper = defaultWrapper) {
    return {
        GetLastSyncedBlock(variables, requestHeaders) {
            return withWrapper((wrappedRequestHeaders) => client.request(exports.GetLastSyncedBlockDocument, variables, Object.assign(Object.assign({}, requestHeaders), wrappedRequestHeaders)), 'GetLastSyncedBlock');
        },
        GetPaymentsAndEscrowState(variables, requestHeaders) {
            return withWrapper((wrappedRequestHeaders) => client.request(exports.GetPaymentsAndEscrowStateDocument, variables, Object.assign(Object.assign({}, requestHeaders), wrappedRequestHeaders)), 'GetPaymentsAndEscrowState');
        },
        GetSyncedBlock(variables, requestHeaders) {
            return withWrapper((wrappedRequestHeaders) => client.request(exports.GetSyncedBlockDocument, variables, Object.assign(Object.assign({}, requestHeaders), wrappedRequestHeaders)), 'GetSyncedBlock');
        }
    };
}
