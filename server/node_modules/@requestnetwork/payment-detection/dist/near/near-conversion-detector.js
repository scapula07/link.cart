...
class NearConversionNativeTokenPaymentDetector extends any_to_native_detector_1.AnyToNativeDetector {
     ...
     */
    extractEvents(eventName, address, paymentReference, requestCurrency, paymentChain, paymentNetwork) {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            ...
            const infoRetriever = new near_conversion_info_retriever_1.NearConversionInfoRetriever(currency, paymentReference, address, NearConversionNativeTokenPaymentDetector.getContractName(paymentChain, paymentNetwork.version), eventName, paymentChain, paymentNetwork.values.maxRateTimespan);
