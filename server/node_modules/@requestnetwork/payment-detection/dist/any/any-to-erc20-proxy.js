...
class AnyToERC20PaymentDetector extends fee_proxy_contract_1.ERC20FeeProxyPaymentDetectorBase {
    ...
    createExtensionsDataForCreation(paymentNetworkCreationParameters) {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            ...
            const salt = paymentNetworkCreationParameters.salt || (yield utils_1.default.crypto.generate8randomBytes());
    ...
    extractEvents(eventName, toAddress, paymentReference, requestCurrency, paymentChain, paymentNetwork) {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            ...
            if (subgraphClient) {
                const infoRetriever = new thegraph_1.TheGraphInfoRetriever(subgraphClient, this.currencyManager);
...
AnyToERC20PaymentDetector.getDeploymentInformation = (0, utils_2.makeGetDeploymentInformation)(smart_contracts_1.erc20ConversionProxy, PROXY_CONTRACT_ADDRESS_MAP);
