...
class BlockchainInfoProvider {
        ...
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            ...
            try {
                ...
                for (let i = 1; i <= numberOfExtraPages; i++) {
                    const resExtraPage = yield utils_1.default.retry(() => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () { return fetch(`${blockchainInfoUrl}/rawaddr/${address}?cors=true&offset=${i * TXS_PER_PAGE}`); }), {
                        maxRetries: BLOCKCHAININFO_REQUEST_MAX_RETRY,
                        retryDelay: BLOCKCHAININFO_REQUEST_RETRY_DELAY,
                    })();
                    // eslint-disable-next-line no-magic-numbers
    ...
    parse(addressInfo, eventName) {
        ...
        const events = addressInfo.txs
            ...
            .filter((output) => output.output.addr === address)
            .map((output) => ({
...
exports.BlockchainInfoProvider = BlockchainInfoProvider;
//# sourceMappingURL=blockchain-info.js.map