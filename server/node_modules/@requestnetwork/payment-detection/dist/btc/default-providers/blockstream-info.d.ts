 ...
 */
export declare class BlockStreamInfoProvider implements PaymentTypes.IBitcoinDetectionProvider {
    /**
     ...
     */
    parse(addressInfo: any, eventName: PaymentTypes.EVENTS_NAMES): PaymentTypes.BTCBalanceWithEvents;
    /**
...
//# sourceMappingURL=blockstream-info.d.ts.map