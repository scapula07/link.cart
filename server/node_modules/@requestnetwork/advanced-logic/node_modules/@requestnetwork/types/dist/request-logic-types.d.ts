...
export interface IRequestLogic {
    createRequest: (requestParameters: ICreateParameters, signerIdentity: Identity.IIdentity, topics: any[]) => Promise<IReturnCreateRequest>;
    createEncryptedRequest: (requestParameters: ICreateParameters, signerIdentity: Identity.IIdentity, encryptionParams: Encryption.IEncryptionParameters[], topics: any[]) => Promise<IReturnCreateRequest>;
    computeRequestId: (requestParameters: ICreateParameters, signerIdentity: Identity.IIdentity) => Promise<RequestId>;
    acceptRequest: (requestParameters: IAcceptParameters, signerIdentity: Identity.IIdentity, validate?: boolean) => Promise<IRequestLogicReturnWithConfirmation>;
    cancelRequest: (requestParameters: ICancelParameters, signerIdentity: Identity.IIdentity, validate?: boolean) => Promise<IRequestLogicReturnWithConfirmation>;
    increaseExpectedAmountRequest: (requestParameters: IIncreaseExpectedAmountParameters, signerIdentity: Identity.IIdentity, validate?: boolean) => Promise<IRequestLogicReturnWithConfirmation>;
    reduceExpectedAmountRequest: (requestParameters: IReduceExpectedAmountParameters, signerIdentity: Identity.IIdentity, validate?: boolean) => Promise<IRequestLogicReturnWithConfirmation>;
    addStakeholders: (requestParameters: IAddStakeholdersParameters, signerIdentity: Identity.IIdentity, encryptionParams: Encryption.IEncryptionParameters[], validate?: boolean) => Promise<IRequestLogicReturnWithConfirmation>;
    addExtensionsDataRequest: (requestParameters: IAddExtensionsDataParameters, signerIdentity: Identity.IIdentity, validate?: boolean) => Promise<IRequestLogicReturnWithConfirmation>;
    getRequestFromId: (topic: string) => Promise<IReturnGetRequestFromId>;
    getRequestsByTopic: (topic: any, updatedBetween?: ITimestampBoundaries) => Promise<IReturnGetRequestsByTopic>;
    getRequestsByMultipleTopics: (topics: any[], updatedBetween?: ITimestampBoundaries) => Promise<IReturnGetRequestsByTopic>;
}
...
export declare enum ACTION_NAME {
    CREATE = "create",
...
//# sourceMappingURL=request-logic-types.d.ts.map