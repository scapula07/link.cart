 ...
 */
class SuperToken extends Token_1.default {
    constructor(options, settings) {
        ...
        this.underlyingToken = new Token_1.default(settings.underlyingTokenAddress);
    }
    get superTokenContract() {
        return new ethers_1.ethers.Contract(this.settings.address, SuperToken_json_1.default.abi);
    }
}
